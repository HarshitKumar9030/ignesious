...
module.exports = async (client) => {
  try {
    try {
      ...
      console.log(`     ┃ `.bold.brightGreen + `  /-/ By https://ucskmcoders.tech /-/`.bold.brightGreen + " ".repeat(-1 + stringlength - ` ┃ `.length - `  /-/ By https://ucskmcoders.tech  /-/`.length) + "┃".bold.brightGreen)
      console.log(`     ┃ `.bold.brightGreen + " ".repeat(-1 + stringlength - ` ┃ `.length) + "┃".bold.brightGreen)
      console.log(`     ┃ `.bold.brightGreen + `  /-/ Discord: Harshit Kumar#9501
 /-/`.bold.brightGreen + " ".repeat(-1 + stringlength - ` ┃ `.length - `  /-/ By Discord:Harshit Kumar#9501
