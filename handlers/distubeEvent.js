console.log(`Welcome to SERVICE HANDLER /--/ By https://ucskmcoders.tech/--/ Discord: Harshit Kumar#9501`.yellow);
...
module.exports = (client) => {
  try {
    ...
    client.distube
      ...
      .on(`empty`, channel =>  message.channel.send(`Voice channel is empty! Leaving the channel...`).catch((e)=>console.log(e)))
