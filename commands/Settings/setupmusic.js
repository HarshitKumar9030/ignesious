    ...
    try {
      ...
      var embeds = [
        ...
        .setImage(message.guild.banner ? message.guild.bannerURL({
          size: 4096
        }) : `https://cdn.ucskm.tech/wp-content/images/iml.png`)
        .setTitle(`Start Listening to Music, by connecting to a Voice Channel and sending either the **SONG LINK** or **SONG NAME** in this Channel!`)
        .setDescription(`> *I support <:youtube:934387497394380850> Youtube, <:spotify:934387022867595366> Spotify, 🔊 Soundcloud and direct MP3 Links!*`)
      ]
      var Emojis = [
        `0️⃣`,
        `1️⃣`,
